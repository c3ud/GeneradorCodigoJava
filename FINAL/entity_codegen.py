...
def main(debug=False):
    ...
    srcgen_folder = join(this_folder, 'ProyectoFinal\Orquesta\src\Musica')
    ...
    # Register filter for mapping Entity type names to Java type names. aca cambio
    ...
    # Load template aca
    template = jinja_env.get_template('archivoJava.template')
